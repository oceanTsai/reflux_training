...
var _Product = require('../../http-service/view/container/Product.jsx');
...
var _ProductAction = require('../reflux/Action/ProductAction.js');

var _ProductAction2 = _interopRequireDefault(_ProductAction);

var _ProductStore = require('../reflux/Store/ProductStore.js');
...
(function () {
    _reactDom2.default.render(_react2.default.createElement(_Product2.default, {
        action: _extends({}, _CommonAction2.default, _ProductAction2.default),
        store: _ProductStore.productStore
...
},{"../../http-service/view/container/Product.jsx":85,"../reflux/Action/CommonAction.js":78,"../reflux/Action/ProductAction.js":79,"../reflux/Store/ProductStore.js":80,"react":58,"react-dom":55}],78:[function(require,module,exports){
'use strict';
...
var _ref = module['exports'] && module['exports']['default'] ? module.exports.default : {},
    productActions = _ref.productActions;

if (module.hasOwnProperty('productActions')) {
    productActions = module.productActions;
} else {
    productActions = _reflux2.default.createActions(["checkedProductChange", "isConfirmChange"]);
}
...
exports.productStore = undefined;
...
var _ProductAction = require('../Action/ProductAction.js');
...
var productStore = exports.productStore = _reflux2.default.createStore({
    listenables: _extends({}, _CommonAction2.default, _ProductAction2.default),
    state: {
        productList: [],
        checkedProduct: null,
        confirmIsShow: false
    ...
    onFindProductSuccess: function onFindProductSuccess(data) {
    ...
    onFindProductFailed: function onFindProductFailed(err) {},

    onCheckedProductChange: function onCheckedProductChange(val) {
        this.state = _extends({}, this.state, {
            checkedProduct: val
        });
        this.trigger(this.state);
...
exports.default = { productStore: productStore };

},{"../Action/CommonAction.js":78,"../Action/ProductAction.js":79,"reflux":69}],81:[function(require,module,exports){
'use strict';
...
},{"../../builder/css/component/Dialog.css":74,"classnames":27,"prop-types":51,"react":58}],82:[function(require,module,exports){
'use strict';
...
},{"classnames":27,"prop-types":51,"react":58}],83:[function(require,module,exports){
'use strict';
...
},{"../../builder/css/component/GeneralButton.css":75,"classnames":27,"prop-types":51,"react":58}],84:[function(require,module,exports){
'use strict';
...
},{"../../builder/css/component/RadioSelect.css":76,"./GeneralButton.jsx":83,"classnames":27,"prop-types":51,"react":58}],85:[function(require,module,exports){
'use strict';
...
var _FooterInfo = require('../component/FooterInfo.jsx');

var _FooterInfo2 = _interopRequireDefault(_FooterInfo);

var _Dialog = require('../component/Dialog.jsx');
...
var Product = function (_Component) {
  ...
  function Product(props) {
    ...
    _this.radioSelectChanged = function (event, item, oldItem) {
      _this.props.action.checkedProductChange(item.value);
    };
  ...
  _createClass(Product, [{
    ...
    value: function render() {
      var _state = this.state,
          ...
          checkedProduct = _state.checkedProduct;

      return _react2.default.createElement('div', { className: 'container' }, _react2.default.createElement('h1', null, "\u6A21\u5F0F2\uFF0C\u7531React Component\u4F5C\u70BA\u7BA1\u7406\u5BB9\u5668"), _react2.default.createElement(_RadioSelect2.default, {
        labelKey: 'name',
        valueKey: 'pid',
        source: productList,
        onChange: this.radioSelectChanged,
        checked: checkedProduct
      }), _react2.default.createElement('div', { className: 'confirm-wrap' }, _react2.default.createElement('button', null, 'show confirm')), _react2.default.createElement(_FooterInfo2.default, { mail: 'in.exit.f2e@gamil.com' }), _react2.default.createElement(_Dialog2.default
      //isShow={true}
      , null));
    }
  }, {
...
Product.proptypes = {
  ...
  productList: _propTypes2.default.array,
  checkedProduct: _propTypes2.default.any
};
...
},{"../component/Dialog.jsx":81,"../component/FooterInfo.jsx":82,"../component/RadioSelect.jsx":84,"prop-types":51,"react":58}]},{},[77]);
